...
<div class="search-cuisine-container">
    <!-- <form method="post" class="form-inline search-form"> -->
        <div class="input-group">
            <input type="text" id="searchInput" class="form-control bg-light border-0 small" placeholder="Search for lunch..." aria-label="Search" aria-describedby="basic-addon2" onkeyup="searchTable()">
    ...
    <div class="dropdown-container">
        <div class="button-container">
            <button onclick="toggleDropdown(this)" name="action" value="Lunch" class="drop">Choose Cuisine</button>
        </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="event-img position-relative text-center">
                                    ...
                                    <div class="event-overlay d-flex flex-column p-4">
                                        ...
                                        <a href="<?php echo URLROOT; ?>/public/food_images/<?php echo $food['imagefile']; ?>" data-lightbox="event-<?php echo $food['category_name']; ?>" class="my-auto"><i class="uil uil-search-plus text-dark fa-2x"></i></a>
